...
app.get('/api/discord/:invite', async (req, res) => {
  ...
  const url = `https://discord.com/api/v10/invites/${encodeURIComponent(code)}?with_counts=true&with_expiration=false`;
  try {
    ...
    return res.status(502).json({ error: 'Failed to fetch Discord invite' });
  }
});
